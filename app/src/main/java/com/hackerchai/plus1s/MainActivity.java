...
public class MainActivity extends AppCompatActivity
    ...
    protected static final String ACTIVITY_TAG="plus1s_MainActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button_about = findViewById(R.id.button);
        button_about.setOnClickListener(new View.OnClickListener() {
                                            @Override
                                            public void onClick(View v) {
                                                Intent launch_about_activity = new Intent(MainActivity.this,AboutActivity.class);
                                                startActivity(launch_about_activity);
                                            }
                                        }
